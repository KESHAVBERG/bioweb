...
const CapsuleEndocopyTest = () => {
  ...
  function handelSubmit(e) {
    ...
    fetch("https://farookheroes.pythonanywhere.com/predict/capsule_endoscopy", options).then((res) => res.json()).then((data) => {
      setResult(data)
      console.log(data)
    }
    )
...
export default CapsuleEndocopyTest